...
namespace TravelExpertsGui.Migrations
{
    public partial class mssql_migration_652 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CustCountry = table.Column<string>(type: "nvarchar(25)", maxLength: 25, nullable: false),
                    CustHomePhone = table.Column<string>(type: "nvarchar(15)", maxLength: 15, nullable: false),
                    CustBusPhone = table.Column<string>(type: "nvarchar(15)", maxLength: 15, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Packages__53E8ED99069759B2", x => x.PackageProductSupplierId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "UQ__Packages__29CA8E959BA8442B",
                table: "Packages_Products_Suppliers",
